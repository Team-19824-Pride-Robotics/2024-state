...
public class blue_stage extends OpMode
{
    ...
    double test = 0;
    double velConstraint = 50;
    double accelConstraint = 50;
    ...
    public void start() {
        ...
        TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startPose)
                ...
                .setConstraints(SampleMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL,DriveConstants.TRACK_WIDTH),SampleMecanumDrive.getAccelerationConstraint(50))                //drive over to the backdrop with the lift facing it
